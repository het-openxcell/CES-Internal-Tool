class LLMPrompts:
    ...
    def occurrence_generation(
        ...
        classification_rules = (
            ...
            "exceeded safe limits. Routine trip gas, bottoms-up gas, or connection gas that was simply "
            "circulated out through the surface system within safe parameters and did not require a flare is "
            "NOT a Gas Spike.\n"
